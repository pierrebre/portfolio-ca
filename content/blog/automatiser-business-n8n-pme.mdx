...
Avant ce workflow, mon client faisait ça à la main chaque vendredi après-midi. Maintenant, c'est fait avant qu'il arrive au bureau le lundi. Et quand l'intégration CRM est mal configurée dès le départ, les dégâts s'accumulent vite — j'ai documenté un cas concret dans mon [étude de cas Piscines Jolicoeur](/projects/piscines-jolicoeur), où un formulaire WordPress envoyait des données erronées au CRM depuis des mois.
