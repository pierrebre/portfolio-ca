...
Un forfait de maintenance mensuel à 200 $ est toujours moins cher qu'une urgence à 1 500 $. Mon [intervention chez Service de Piscines Jolicoeur](/projects/piscines-jolicoeur) illustre exactement ce scénario : une agence disparue, des problèmes accumulés sur un formulaire WordPress, et un CRM qui recevait des données erronées depuis des mois.
